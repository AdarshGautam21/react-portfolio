  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={twitterImg} alternate="Twitter" redirectURL="https://twitter.com/AdarshG72503856" />
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/AdarshGautam21" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:adarshgofficial21@gmail.com" />
          <SocialLogo imgURL={instaImg} alternate="Instagram" redirectURL="https://www.instagram.com/adarshgautam.21" />
          {/* <SocialLogo imgURL={dribbbleImg} alternate="Dribbble" redirectURL="https://dribbble.com/sureshmurali29" /> */}
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/AdarshGautam21" />
        </SocialMediaIcons>
      </Container>
    );
  }
